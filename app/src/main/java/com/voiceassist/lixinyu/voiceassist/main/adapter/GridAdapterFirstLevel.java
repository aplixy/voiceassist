...
public class GridAdapterFirstLevel extends GridAdapter {

    public GridAdapterFirstLevel(Context context, List<GridViewVo> data, int columCount) {
        super(context, data, columCount);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.main_item_first_level;
    }

    @Override
    protected void renderView(View convertView, GridViewVo vo) {
        TextView tv = convertView.findViewById(R.id.main_item_first_level_textview);
