...
class AssistApplication : Application() {
    ...
    companion object {
        ...
        val APP_ID = "9cf0826f88" // TODO 替换成bugly上注册的appid
        val APP_CHANNEL = BuildConfig.bugly_app_channel // TODO 自定义渠道
        private val TAG = "OnUILifecycleListener"
         ...
         * @return
         */
        val instance: AssistApplication?
            get() {
    ...
    private fun buglyInit() {
         ...
         * 设置app渠道号
         */
        strategy.appChannel = APP_CHANNEL

        Bugly.init(applicationContext, APP_ID, false, strategy)
    }
